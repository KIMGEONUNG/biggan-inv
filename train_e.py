...
def parse_args():
    ...
    parser.add_argument('--task_name', default='encoder_f_16_v3')
    parser.add_argument('--detail', 
        default='use samping real image for discriminator training.\
        the reason for this is that we suspect that the cause of poor\
        performance of discriminator is to the small number of dataset')
    ...
    parser.add_argument('--coef_adv', type=float, default=0.1)
