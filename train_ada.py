...
import models
from encoders import EncoderF_ada
...
def parse_args():
    ...
    parser.add_argument('--task_name', default='ada_v2')
    parser.add_argument('--detail', default='class condition model \
            using 4 classes')
    ...
    # IO
    parser.add_argument('--path_log', default='runs_ada')
